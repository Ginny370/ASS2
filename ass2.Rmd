...
metafor::funnel(x = final$lnRR, vi = final$V_lnRR, yaxis = "seinv",
    digits = 2, xlim=c(-10,10), ylim=c(1,150),level = c(0.1, 0.05, 0.01), shade = c("white", "cyan1", "cyan4", "darkblue"),col="orange",
...
```{r}
lvlnRR <- rma.mv(lnRR ~ (1 / lnRR_var), v = V_lnRR, random = list(~1 | Study, ~1|residual), test = "t", dfs = "contain", data = final)
```
